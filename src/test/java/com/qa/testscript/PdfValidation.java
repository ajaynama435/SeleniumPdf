...
public class PdfValidation {
	...
	/*
	 * @Test public void readPdfContent() throws IOException { URL pdfurl = new
	 * URL(url); InputStream ip = pdfurl.openStream(); BufferedInputStream bf = new
	 * BufferedInputStream(ip); PDDocument pdDocument = PDDocument.load(bf); int
	 * pageCount = pdDocument.getNumberOfPages(); System.out.println(pageCount);
	 ...
	 * 
	 * pdfStripper.setStartPage(1); String pdfText1 =
	 * pdfStripper.getText(pdDocument);
